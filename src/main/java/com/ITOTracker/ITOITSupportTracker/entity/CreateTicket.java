...
public class CreateTicket {
    ...
    public CreateTicket(Integer ticket_id, Integer category_id, Integer sub_category_id, Integer assignee_Id, Integer user_id, String subjects, String description, Integer status_id, Integer priority_id, LocalDateTime create_datetime) {
       this.ticket_id = ticket_id;
        this.category_id = category_id;
        this.sub_category_id = sub_category_id;
        this.assignee_Id = assignee_Id;
